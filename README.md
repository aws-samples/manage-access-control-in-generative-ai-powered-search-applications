...
1. Fork this GitHub repository and take note of your repository URL, for example https://github.com/<USERNAME\>/manage-access-control-in-generative-ai-powered-search-applications/.
...
1.	Open frontend/deploy.sh and put the github repository url in FRONTEND_REPOSITORY. It should be something like ‘https://github.com/<USERNAME\>/manage-access-control-in-generative-ai-powered-search-applications/'
