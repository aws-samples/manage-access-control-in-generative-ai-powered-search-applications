...
class RAGCdkStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, config: dict, **kwargs) -> None:
        ...
        user_pool = cognito.UserPool(
            ...
            'AOSUserPool',
            custom_attributes= {
                "custom:department": cognito.StringAttribute(min_len=1, max_len=100, mutable=True),
                "custom:access_level": cognito.StringAttribute(min_len=1, max_len=100, mutable=True),
        ...
        ingestion_lambda_function = PythonFunction(self, "DataIngestionLambda",
        ...
        ingestion_lambda_function.role.attach_inline_policy(
            iam.Policy(self, "IngestionLambdaExecutionPolicy",
            statements=[
                iam.PolicyStatement(
        ...
        search_lambda.role.attach_inline_policy(
            iam.Policy(
                self, "SearchLambdaExecutionPolicy",
                statements=[
                    iam.PolicyStatement(
        ...
        user_pool = cognito.UserPool.from_user_pool_arn(self, "ImportedUserPool", user_pool_arn=user_pool.user_pool_arn)
        ...
        self.add_to_param_store("AosEndpointParam", "AosEndpoint", prod_domain.domain_endpoint)
        self.add_to_param_store("AosArnParam", "AosArn", prod_domain.domain_arn)
        self.add_to_param_store("UserPoolArn", "CognitoUserPoolArn", user_pool.user_pool_arn)
        self.add_to_param_store("UserPoolClientID", "UserPoolClientID", user_pool_client.user_pool_client_id)
        self.add_to_param_store("APIGWInvokeEndpoint",
                                 "APIGWInvokeEndpoint",
